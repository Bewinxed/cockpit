...
export {
  ...
  type ThinkingMode,
  type ThinkingSetParams,
  type ThinkingSetResult,
...
export {
  ...
  type InstanceTurnStartedEvent,
  type InstanceTurnCompletedEvent,
...
export const PROTOCOL_METHODS = {
  ...
  THINKING_SET: CommandMethod.THINKING_SET,
  ...
  INSTANCE_TURN_STARTED: EventMethod.INSTANCE_TURN_STARTED,
  INSTANCE_TURN_COMPLETED: EventMethod.INSTANCE_TURN_COMPLETED,
