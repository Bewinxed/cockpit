...
- [x] G1: All contract types + STREAM_V1 exist verbatim-compatible in stream.ts
  CHECK: cd /home/bewinxed/cockpit && grep -cE "STREAM_V1|SessionStreamEvent|StreamSubscribe|StreamBacklog|StreamReset|StreamDelta|CommandEnvelope|CommandAck" packages/core/src/stream.ts
  EXPECT: /^([8-9]|[1-9][0-9])/
  EVIDENCE: 13

- [x] G2: Exported from the package root
  CHECK: cd /home/bewinxed/cockpit && grep -c "stream" packages/core/src/index.ts
  EXPECT: /^[1-9]/
  EVIDENCE: 5
