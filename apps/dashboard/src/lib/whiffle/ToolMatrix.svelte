...
{:else if machines.length === 0}
  <Card class="flex flex-col gap-[var(--space-3)] rounded-[var(--radius-panel)] p-[var(--space-6)] shadow-md">
    ...
    <pre class="overflow-x-auto rounded-[var(--radius-well)] bg-muted px-[var(--space-3)] py-[var(--space-2)] font-mono text-micro">WHIFFLE_HUB_URL=ws://&lt;this-host&gt;:3456/ws whiffle up</pre>
  </Card>
{:else}
