<script lang="ts">
  ...
  import type { FleetConfig, FleetPlugin, FleetSkillMeta, MarketplacePluginInfo } from '@whiffle/core';
...
{:else}
  <section class="flex flex-col gap-3">
    ...
    <p class="max-w-prose text-micro text-muted-foreground">
      Whiffle installs a skill's files. A skill that also ships hooks or subagents runs in its
