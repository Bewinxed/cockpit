import type { DelegateEffort, DelegateType } from '@cockpit/core';
import { delegateTypeProblem, HARNESSES } from '@cockpit/core';
 ...
 * print.
 *
 * Validation lives in `@cockpit/core`'s `delegateTypeProblem`, reused here
