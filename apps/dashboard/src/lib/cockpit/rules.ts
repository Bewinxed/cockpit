import type { Rule, RuleDraft, RuleRow } from '@cockpit/core';
import { RULE_TEMPLATES } from '@cockpit/core';
 ...
 *
 * The matching and validation live in `@cockpit/core` rather than here, on
