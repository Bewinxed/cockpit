<script lang="ts" module>
	...
	export const toggleVariants = tv({
		...
		variants: {
			...
			size: {
				default: "h-[var(--c-nav-h)] min-w-[var(--c-nav-h)] px-3 has-data-[icon=inline-end]:pr-2.5 has-data-[icon=inline-start]:pl-2.5",
