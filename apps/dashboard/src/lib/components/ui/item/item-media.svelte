	...
	export const itemMediaVariants = tv({
		...
		variants: {
			variant: {
				...
				image: "size-10 overflow-hidden rounded-[var(--radius-control)] group-data-[size=sm]/item:size-8 group-data-[size=xs]/item:size-6 group-data-[size=xs]/item:rounded-[var(--radius-mark)] [&_img]:size-full [&_img]:object-cover",
			},
		},
		defaultVariants: {
			variant: "default",
