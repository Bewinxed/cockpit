					...
					{#if message.metadata?.authUrl}
						<div class="space-y-2">
							...
							<a
								...
								class="flex items-center gap-2 px-4 py-2.5 bg-primary text-primary-foreground rounded-md hover:bg-primary/90 hover:text-primary transition-colors text-sm font-medium group w-fit"
							>
