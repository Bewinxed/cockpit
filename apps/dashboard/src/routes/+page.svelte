...
<div class="p-8 max-w-[1400px] mx-auto animate-fade-in">
  ...
  >
    <div>
      <span
        class="text-[10px] font-mono text-muted-foreground uppercase tracking-[0.2em] mb-2 block"
        >Overview</span
      >
      <h1 class="text-4xl font-sans font-bold text-foreground tracking-tight">
        Dashboard
      </h1>
      <p class="text-muted-foreground mt-2 text-sm">
        Manage your Claude Code instances across all devices
      </p>
    </div>
  ...
  <div class="grid grid-cols-1 lg:grid-cols-5 gap-6">
    ...
    <section class="lg:col-span-3">
      <div class="bg-card border border-border">
        <div
          class="flex justify-between items-center p-5 border-b border-border"
        >
          <div class="flex items-center gap-3">
            <div class="w-1.5 h-1.5 rounded-full bg-primary"></div>
            <h2
              class="text-[11px] font-mono text-muted-foreground uppercase tracking-[0.15em]"
            >
              Recent Instances
            </h2>
          </div>
      ...
      <div class="bg-card border border-border relative overflow-hidden">
        ...
        <div class="p-6">
          <div class="flex items-start gap-5">
            <div
              class="w-12 h-12 bg-primary flex items-center justify-center flex-shrink-0"
            >
              <Zap class="w-6 h-6 text-primary-foreground" />
            </div>
            <div class="flex-1">
              <h3 class="font-sans font-bold text-xl text-foreground mb-2">
                Get Started with Cockpit
              </h3>
              <p class="text-sm text-muted-foreground mb-6">
                Cockpit lets you manage Claude Code instances across multiple
                machines. Here's how to get started:
              </p>
              <div class="space-y-4">
                <div class="flex items-start gap-4">
                  <span
                    class="w-8 h-8 bg-primary text-primary-foreground flex items-center justify-center text-sm font-mono font-bold flex-shrink-0"
                    >01</span
                  >
                  <div>
                    <p class="text-sm font-medium text-foreground mb-1">
                      Start an agent on your machine
                    </p>
                    <code
                      class="text-xs font-mono bg-muted px-3 py-1.5 inline-block text-muted-foreground border border-border"
                      >cockpit agent</code
                    >
                  </div>
                </div>
                <div class="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p class="text-xs text-muted-foreground">
                      Click "New Instance" to spawn a Claude Code session
                    </p>
                  </div>
                </div>
                <div class="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p class="text-xs text-muted-foreground">
                      Send messages and watch Claude work on your code
                    </p>
                  </div>
                </div>
              </div>
  ...
  {#if $connectionStatus !== "connected"}
    <div class="fixed bottom-6 right-6 animate-fade-in-up z-50">
      <div
        class="bg-card border border-border p-4 flex items-center gap-3 shadow-lg {$connectionStatus ===
        'connecting'
      ...
      >
        {#if $connectionStatus === "connecting"}
          ...
          <span class="text-xs font-mono text-warning uppercase tracking-wider"
            >Connecting...</span
          >
        {:else if $connectionStatus === "error"}
          <div class="w-2 h-2 rounded-full bg-error"></div>
          <span class="text-xs font-mono text-error uppercase tracking-wider"
